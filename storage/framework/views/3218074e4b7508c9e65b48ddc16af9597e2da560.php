...
<html lang="en">
    ...
    <div class="linkbar">
        ...
        <div class="small smlborder">
            <div class="links">
                <h3>404 Error. De gevraagde pagina is er helaas niet.</h3>
                <img src="storage/todo-house.jpg" alt="old house photo" title="old house photo" width="400" height="256">
            </div>
            <div class="rand">
                <div class="main">Jammer.</div>
                <button class="button" onclick="myparagraaf()">Click me!</button>
            </div>
        </div>
    </body>
</html>
<?php /**PATH /var/www/html/project/resources/views/errors/404.blade.php ENDPATH**/ ?>