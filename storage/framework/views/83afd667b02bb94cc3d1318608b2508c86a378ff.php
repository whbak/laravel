    ...
    <div class="linkbar">
        ...
        <div class="large smlborder">
            ...
            <div class="rand">
                ...
                <?php echo csrf_field(); ?>
                    <div>
                        <label for="nummer">Kies het text id nummer: <span class="span-redfont"><?php echo e($eerst); ?></span></label>
...
<?php /**PATH /var/www/html/project/resources/views/wipetext.blade.php ENDPATH**/ ?>