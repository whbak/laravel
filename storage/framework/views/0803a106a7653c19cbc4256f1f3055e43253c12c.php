    ...
    <div class="linkbar">
        ...
        <div class="small smlborder">
            <div class="links">
                ...
                <h3>Project van: <?php echo e($username); ?></h3>
            ...
            <div class="rand">
                <form action="" method="POST">
                    <?php echo csrf_field(); ?>
                    <div>
                        <label for="">In te vullen: <span-redfont><?php echo e($eerst); ?></span-redfont></label>
                    </div><div><hr>
                        ...
                        <input class="adddata" required type="text" id="username" name="username" value="<?php echo e($username); ?>">
                    </div><div><hr>
...
<?php /**PATH /var/www/html/project/resources/views/store.blade.php ENDPATH**/ ?>