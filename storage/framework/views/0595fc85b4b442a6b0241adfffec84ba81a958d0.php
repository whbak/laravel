...
<html lang="en">
    ...
    <div class="linkbar">
        ...
        <div class="medium smlborder">
            <div class="links">
                <h3>Todo projectlijst sorteer volgorde</h3>
                <img src="<?php echo e($image); ?>" alt="query" title="query" width="128" height="128">
            </div>
            <div class="rand">
                <form action="" method="POST">
                <?php echo csrf_field(); ?>
                    <div>
                        <label for="sorteer">Sorteer oplopend:</label>
                        <input class="adddata" required type="radio" id="sorteer" name="sorteer" value="asc">
                    </div><div>
                        <label for="sorteeraflopend">Sorteer aflopend:</label>
                        <input class="adddata" type="radio" id="sorteeraflopend" name="sorteer" value="desc">
                    </div><hr>
...
<?php /**PATH /var/www/html/project/resources/views/query.blade.php ENDPATH**/ ?>