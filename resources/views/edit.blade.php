            ...
            <div class="rand">
                <form action="/update" method="POST">
                    ...
                    <div>
                        ...
                        <label hidden for="id">Gekozen project id: {{ $todo->id }}</label>
                        <input class="adddata" hidden type="number" id="id" name="id" value="{{ $todo->id }}">
                    </div><div><hr>
                        <label for="sequence">Wat komt eerst?</label>
                        <input class="adddata" required type="number" id="sequence" name="sequence" value="{{ $todo->sequence }}">
                    </div><div><hr>
                        <label for="username">Projectleider: {{ $todo->username }}</label>
                        <input class="adddata" hidden type="text" id="username" name="username" value="{{ $todo->username }}">
                    </div><div><hr>
                        <label for="todo">Projectnaam:</label>
                        <input class="adddata" required type="text" id="todo" name="todo" value="{{ $todo->todo }}">
                    </div><div><hr>
                        <label for="begin">Start datum:</label>
                        <input class="adddata" required type="date" id="begin" name="begin" value="{{ $todo->begin }}">
                    </div><div><hr>
                        <label for="finish">Eind datum:</label>
                        <input class="adddata" required type="date" id="finish" name="finish" value="{{ $todo->finish }}">
                    </div><div><hr>
                        <label for="status">Welk van de statussen?</label>
                        <select class="adddata" name="status">
                        <option value="new">{{ $todo->status }}</option>
